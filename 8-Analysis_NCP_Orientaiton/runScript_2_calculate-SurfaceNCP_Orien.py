...
for typ in ['SP2','SP3','nucleiA','dropS','dropH1']: ## SP1 too small to distinguish the interior/surfaceNCP
    # select the condensates' surface NCPs which within 11 nm (a NCP diameter) distance from the outer most shell
...
plt.show()
fig1.savefig('SurfaceNCP_Orientation.png', dpi=400)
